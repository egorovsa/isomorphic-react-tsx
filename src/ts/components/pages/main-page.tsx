                ...
                <div className="container">
                    ...
                    <div className="advant-block hi-cost">
                        ...
                        <div className="right">
                            ...
                            <div className="description">
                                После точного взвешивания предлагаем честную и конкурентную цену на лом цветного и черного
                                металла.
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="advant-block pickup">
                        ...
                        <div className="right">
                            ...
                            <div className="description">
                                Парк спецтехники позволяет быстро и в удобное время организовать вывоз цветного металл от 300 кг
                                бесплатно.
                            </div>
                        </div>
                    </div>
